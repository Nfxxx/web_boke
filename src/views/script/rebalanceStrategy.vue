<template>
  <div>
    <h2 class="page-title">换仓策略测试</h2>
    <template>
      <el-button class="filter-item" style="margin-left: 20px" type="primary" @click="RebalanceStrategy">
        确定
      </el-button>
    </template>
    <br>
...
<script>
    import { rebalanceStrategy } from "@/api/script"
    ...
    export default {
        ...
        methods: {
            RebalanceStrategy() {
                rebalanceStrategy().then(response => {
