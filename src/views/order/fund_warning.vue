  ...
  <div style="margin-left: 5px;margin-bottom: 5px;margin-top: 10px;margin-right: 5px;">
    ...
    <article>
      <el-table :data="tableData" style="width: 100%" :border="true">
        <el-table-column prop="公司" label="公司"  width="200"></el-table-column>1
        <el-table-column prop="账号开立率" label="账号开立率" width="200"></el-table-column>
        <el-table-column prop="机构诚信信息	" label="机构诚信信息" minWidth="300"></el-table-column>
      </el-table>
    </article>
  </div>
</template>
...
import {YeijiWeiDu,YejiJizhunStatus} from "@/filters/OrderFilter";
...
export default {
  ...
  methods: {
    ...
    //
    async findList() {
      axios.post('http://172.18.103.142:5555/table/fund_waring',this.searchObj, {
        headers: {
